    ...
    <section className="py-24 bg-card border-y border-border">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-foreground">A Escolha é Sua</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-16">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-start gap-3 text-muted-foreground">
                  <span className="h-6 w-6 rounded-full bg-destructive/10 flex items-center justify-center shrink-0 mt-0.5">
          ...
          {/* With ALG */}
          <div className="bg-secondary border border-border rounded-2xl p-8 md:p-10 text-foreground shadow-2xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-primary/10 rounded-full -mr-16 -mt-16 blur-2xl" />
            <h3 className="text-2xl font-bold mb-6 text-foreground flex items-center gap-3 relative z-10">
              <CheckCircle2 className="h-6 w-6 text-primary" />
              Com a ALG Finanças Pessoais
            </h3>
